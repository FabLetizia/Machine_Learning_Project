...
"""
L'APE è il tipo di trader che sono nuovi nel mercato azionario.
Tendono a scegliere le azioni in modo irrazionale
"""
class backtester(simulator):
        ...
        while self.day <= self.end_date:
            ...
            if self.status == 'buy':
                ...
                for s in stocks:
                    ...
                    # la logica di vendita della classe backtester si basa su una scelta random
    ...
    """
    Nel caso del backtester_ape viene scelto casualmente un titolo dalla lista dei titoli (self.stocks)
    e vengono ottenuti i dati storici per quel titolo tramite la funzione
    get_stock_data. I dati vengono quindi salvati nel dizionario daily_scanner.
    """
    def scanner(self):
        """
